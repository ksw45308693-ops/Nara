...
body{margin:0;background:#f3f6f8;color:#162331;font:14px/1.55 Arial,sans-serif}.report{max-width:1180px;margin:0 auto;padding:28px}.header{background:#092a4a;color:#fff;padding:24px;border-radius:10px}.header h1{margin:0;font-size:24px}.header p{margin:5px 0 0;color:#bcecff}.meta,.summary,.query,.grid,.notice{background:#fff;border:1px solid #d9e2e8;border-radius:8px;margin-top:16px;padding:18px}.meta{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.label{color:#527080;font-size:12px}.value{font-weight:600}.counts{display:flex;flex-wrap:wrap;gap:8px}.count{background:#e6f7f7;color:#0b5d68;border-radius:999px;padding:4px 10px}.query dl{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px 20px;margin:10px 0 0}.query dl div{display:grid;grid-template-columns:70px 1fr}.query dt{color:#527080}.query dd{margin:0}.grid-head{display:flex;justify-content:space-between;margin-bottom:10px;font-weight:600}.grid-scroll{overflow-x:auto}table{border-collapse:collapse;min-width:1180px;width:100%}th,td{border:1px solid #d9e2e8;padding:8px;text-align:left;vertical-align:top}th{background:#e6f7f7;color:#0b5d68;white-space:nowrap}.number{font-variant-numeric:tabular-nums;white-space:nowrap}.name{min-width:180px}.evidence{margin-top:16px}.evidence>summary{cursor:pointer;font-weight:600}.notice h2{font-size:18px;margin:0 0 8px}.notice dl{display:grid;grid-template-columns:100px 1fr;gap:5px 12px;margin:0}.notice dt{color:#527080}.notice dd{margin:0}.matches{margin:12px 0 0;padding-left:18px}.matches li{margin:5px 0}.source{overflow-wrap:anywhere}.empty{color:#527080}@media print{body{background:#fff}.report{max-width:none;padding:0}.header,.meta,.summary,.query,.grid,.notice{break-inside:avoid}}
